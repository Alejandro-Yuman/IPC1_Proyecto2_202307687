...
function LikedPostChart() {
    ...
    useEffect(() => {
        ...
        const labelsPost = lista.map(itemUser => itemUser.id)
        const dataPost = lista.map(itemUser => itemUser.likes.length)
